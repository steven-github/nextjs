...
export default function Home({ isLoading }) {
  ...
  const CONFIGURATION = {
    ...
    // mapsApiKey: "AIzaSyCm7BRUBs8nlIb3AvzVRcuOALEDnngcrgA",
  };

  const handleScriptLoad = () => {
    // Try HTML5 geolocation.
    if (navigator.geolocation) {
      console.log('Getting your current position...', loading);
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          CONFIGURATION.locations[0].coords = pos;
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen py-2">
        <div className={`flex items-center justify-center space-x-2 animate-pulse ${isLoading ? 'visible' : 'invisible'}`}>
